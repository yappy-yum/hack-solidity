...
contract TSwapPool is ERC20 {
    ...
    function deposit(
        ...
        uint64 deadline
        // @audit-high used to be control deposit, but not used
    )
        external
        ...
        returns (uint256 liquidityTokensToMint)
    {
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            // @audit-info would be better to put before _addLiquidityMintAndTransfer
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // @audit-low incorrect event emit
        ...
        revertIfZero(minPoolTokensToWithdraw)
    {
        ...
        // Note:
        // burn shares * ( token reserve / total liquidity token supply )
    ...
    function getOutputAmountBasedOnInput(
        ...
        public
        pure
        // @audit-info `inputReserves` no zero checks
        revertIfZero(inputAmount)
        revertIfZero(outputReserves)
        // @audit-info return param is not used
        ...
        returns (uint256 inputAmount)
    {
        ...
        // .
        // .
        // x * outputAmount = inputAmount ( y - outputAmount )
        ...
        // @audit-high fees too low !! did you mean 1_000 instead of 10_000?
        return
        ...
        returns (uint256 inputAmount)
    {
        ...
        // @audit-high missing max input amount 
    ...
    function sellPoolTokens(
        ...
        // @audit-high incorrect arguments
        return
            swapExactOutput(
                i_poolToken,
                i_wethToken,
