...
contract ThunderLoan is Initializable, OwnableUpgradeable, UUPSUpgradeable, OracleUpgradeable {
    ...
    // @audit-info preferably have constant/immutable
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // @audit-low no access control, possible front-running, calls before u do ...
    //            to break this contract or whatever the reason is !!!
    ...
    function deposit(IERC20 token, uint256 amount) external revertIfZero(amount) revertIfNotAllowedToken(token) {
        ...
        // @audit-high reward manipulation
        // LP will only provide more tokens with equivalent value

        // Note:
        // only flash loan will manipulate exchange rate because
        // flash loan contains fee, causing Inequivalent value, therefore
        // exchange rate manipulated
    ...
    function flashloan(address receiverAddress, IERC20 token, uint256 amount, bytes calldata params) external {
        ...
        // @audit-high 
        // verify fees by using contract balance
        // attacker can use `deposit` function, bypassing fees verification below ...
        //  then call `redeem` to withdraw the fees paid
        repay(token, fee + amount);
